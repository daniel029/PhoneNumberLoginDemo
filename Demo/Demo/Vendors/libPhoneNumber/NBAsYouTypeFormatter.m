...
/**
 * @return  YES if a new template is created as opposed to reusing the
 *     existing template.
 * @private
 */
...
/**
 * @param leadingThreeDigits leadingThreeDigits first three digits of entered number.
 * @private
 */
 ...
 *
 * @param  nextChar the most recently entered digit of a phone number.
 ...
 * @param  nationalNumber The number to be appended.
...
/**
 * @return  YES if the current country is a NANPA country and the
 ...
 *
 * @return  YES when accruedInputWithoutFormatting begins with the
 ...
 *
 * @return  YES when a valid country calling code can be found.
 * @private
 */
